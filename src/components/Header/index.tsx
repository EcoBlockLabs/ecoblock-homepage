...
const Header: React.FC<IHeaderProps> = ({ activeMenuItem }) => {
  ...
  return (
    <div className="header w-full z-50 max-xl:px-[20px] fixed h-[72px] items-center max-md:px-[16px] flex gap-3 justify-between">
      <div className="container mx-auto flex gap-3 justify-between items-center w-full">
